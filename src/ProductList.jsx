...
function ProductList({ onHomeClick }) {
    ...
    const totalInCard = calculateTotalInCart();
                    ...
                    <div>
                        <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                            <h1 className='cart' style={{ position: 'relative' }}>
                                {totalInCard > 0 && (
                                    <div style={{ position: 'absolute', right: 0, top: 0, backgroundColor: 'red', borderRadius: "50%", fontSize: "14px", width: "24px", height: "24px", display: 'flex', justifyContent: "center", alignItems: 'center' }}>
                                        <span>{totalInCard}</span>
                                    </div>
                                )}
